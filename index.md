...
<table style="font-size: 0.85em; border-collapse: collapse; font-family: sans-serif;">
 ...
 <caption style="caption-side: bottom; font-style: italic; margin-bottom: 8px;">
...
<br>
And amid all the buzz, one question often gets overlooked: how clean is your next meal, really?
...
The NYC Health Department oversees the health, safety, and well-being of New Yorkers. As part of this responsibility, it monitors the sanitation and cleanliness of NYC restaurants. The Health Department scores the restaurants on an A, B, C scale that represents how many sanitary violation points are given, hereafter referred to as the ‘health grade’. The grade represents sanitary violations like incorrect temperature on storage or evidence of rodents [3]. Every restaurant is evaluated at least once a year and more if the restaurant receives a bad grade. In this article we work with restaurants evaluated in the two-year period 2022 to 2024 [4]. We combine this with review ratings of New York restaurants found on TripAdvisor from 2004 to 2020, referred to as the ‘review rating’. Each restaurant is rated on the scale from 1-5 with 5 being the best [5].
<br><br>
...
How well do customer reviews reflect a restaurant’s actual cleanliness? To explore this, we compared long-term TripAdvisor ratings with official health inspection scores across New York City’s five boroughs. This side-by-side look offers insight into whether popular opinion aligns with public health data—or reveals a deeper disconnect. The results are illustrated in Figure 1.
There is little to no correlation between public ratings and official health grades. This disconnect likely stems from the differing criteria used by diners and inspectors. While health department evaluations focus solely on hygiene and safety—often invisible to the average customer—public reviews typically emphasize the more immediate, subjective aspects of the dining experience: food quality, flavor, service, ambiance, and value. A restaurant could offer a delicious meal in a cozy setting with attentive staff and still receive a low health grade due to back-of-house health violations that most customers will never see. Conversely, a spotlessly clean establishment with bland food or poor service might earn an 'A' grade but still receive mediocre reviews. <br><br>
...
<figcaption style="font-style: italic; text-align: center; margin-top: 10px; color: #555;">
 Figure 1: Scatterplot showing the correlation between restaurant cleanliness and their average customer rating. It is eyecatching how the health grade seems to be independent of how good or bad the reviews of a restaurant is.
</figcaption>
</figure>
...
For visitors trying to make the most of New York City’s food scene, it helps to first get a sense of the overall restaurant landscape. In this section, we give an overview of where the most restaurants are located, which types of cuisine you’re most likely to encounter, and what common health violations inspectors tend to find. All these insights are collected in an overview in Figure 2. We then shift focus in Figure 3, which compares health inspection grades with customer-generated review ratings across boroughs. Together, these two overviews provide a balanced snapshot of both regulatory and public perspectives on dining quality in NYC. So whether you’re staying in Manhattan or venturing into Queens or the Bronx, this background can help you make smarter, safer choices.
...
<summary style="cursor: pointer; font-weight: bold; font-size: 1em;">
 Table 2: Click to show most frequent health code violations
</summary>
...
The health department inspects many different aspects, the most prevailing violations are shown in the plot ‘Violation codes’ in Figure 2 as well as full violation descriptions in the fold-out Table 2. Code 10F, for instance, which denotes ‘Unsanitary or inaccessible surface’, appears most frequently. Others like ‘Pest-conductive conditions‘(08A) and ‘Unsanitized food surface’ (06D) are also common. These highlight operational lapses that could affect food safety, even in otherwise well-rated restaurants. Being aware of these recurring issues can help diners make informed decisions, especially when selecting lower-profile eateries.
...
Manhattan is the only borough where 'A' health grades clearly outnumber the combined total of 'B' and 'C' grades, though Brooklyn comes close with approximately as many B’s and C’s. This could be due to greater resources, tighter management, or perhaps more pressure to maintain reputational standards in the tourism-heavy boroughs. Staten Island, Bronx and Queens show larger amounts of grade ‘B’ incidents. Queens has the largest amount of ‘C’ grades, indicating a lower focus on sanitation—a detail that may prompt more careful restaurant selection for health-conscious visitors.

<br><br>

Turning to the rating distribution portion of Figure 3, which reflects customer satisfaction, Manhattan again leads with the highest share of 5-star reviews. This likely stems from its dense concentration of high-end restaurants, well-staffed eateries, and overall tourist-oriented service. Brooklyn and Queens follow closely, with impressive proportions of 4 and 5-star ratings, reinforcing their reputations as emerging culinary hotspots. The Bronx and Staten Island, while more modest in their review scores, still hold a steady presence in the mid-tier range—mostly 3s and 4s—suggesting reliable but less standout experiences. However, as discussed earlier in this article, anything below approximately a 4 rating tends to fall into the below-average category, making this a potential consideration when dining further from central boroughs.
...
<br><br>
The keen observer will notice that Staten Island breaks the otherwise fairly uniform pattern. This might be due to the health inspectors being able to cover the restaurants in shorter, more concentrated periods. For this reason the following will be built overlooking Staten island.
Focusing on the better scoring restaurants with health grade ‘A’, there is a trend of higher rate of inspections with this grade in the spring months March, April and May. Meaning that if you wish to sort through restaurants knowing they recently got a good grade, the spring time is ideal for visiting the city.
<br><br>
On the other hand if you want to avoid the critical health grade ‘C’, one could argue that the winter half year is a better time to visit New York City. In this period there seems to be less health gradings of ‘C’ across all boroughs, suggesting that the cooler weather and perhaps less tourism reduces stress and makes room for better sanitation. On the other hand, the higher rates of ‘C’ gradings and warmer weather during the summertime is an indicator that some restaurants that do good in the winter, might perform worse in the summertime.



<br><br>
Taking a look at Staten Island we see that the grade ‘A’ plot has a high number of inspections  in January, March, April and august. Grade ‘B’ plots large numbers in March and especially in october. Grade ‘C’ plot, January, July, August and again high numbers in october. Conversely one could argue that visiting New York City in the summer is actually the safest time, as restaurants with varying sanitation more often get flagged during this time.
<br><br>
...
<br><br>
This intuitive visual format makes it easy to scan your surroundings and spot well-reviewed and hygienically sound eateries at a glance. By dragging your cursor over a dot, you can view detailed information including the restaurant's name, the type of cuisine it serves, borough location, health score and corresponding grade, and, if available, review rating. Review ratings, when available, are based on our compiled TripAdvisor data. For chain restaurants without specific location reviews, we use the average rating of that chain’s Manhattan locations as a proxy.
...
<figcaption style="font-style: italic; text-align: left; margin-top: 10px; color: #555;">
 Figure 6: Interactive map where all individual restaurants can be viewed with average health grade and possible rating. <br>One can select all or individual boroughs, all or individual grades and lastly all or one specific cuisine. <br> Combinations here can freely be explored.
</figcaption>
</figure>


<br><br>
So whether you're wandering through Manhattan, checking out Brooklyn's vibrant neighborhoods, or exploring the Bronx, Queens, or Staten Island, Figure 6 offers a practical tool and is a handy companion for navigating the city's food scene. Craving a classic American bite, a cozy café, or something more adventurous like Jamaican or Armenian dishes? This map helps make sure every meal in New York City is a delicious discovery.
<br><br>
In a city where every corner serves something delicious, the key is knowing what’s behind the kitchen door—and now, you do.
<br><br><br><br>
...
<a href="https://github.com/HaleFader/HaleFader.github.io">Link to explainer repository with explainer notebook</a>
